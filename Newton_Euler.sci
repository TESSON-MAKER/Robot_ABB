...
//3w3point
dW3xA(i)=-dT1(i)*dT2(i)*cos(T2(i)-T3(i))-ddT1(i)*sin(T2(i)-T3(i))-dT1(i)*dT3(i)*cos(T2(i)+T3(i));
dW3yA(i)=ddT2(i)+ddT3(i);
dW3zA(i)=-dT1(i)*dT2(i)*sin(T2(i)-T3(i))+ddT1(i)*cos(T2(i)+T3(i))-dT1(i)*dT3(i)*cos(T2(i)+T3(i));

/******DVG analytique*********/
//1vG1point
dVG1xA(i) = -(l2/2)*dT1(i)^2;
dVG1yA(i) = (l2/2)*ddT2(i);
dVG1zA(i) = 0;

//2vG2point
dVG2xA(i)= -l2*dT1(i)^2*cos(T2(i))+(l3/2)*(ddT2(i)-dT1(i)^2*cos(T2(i))*sin(T2(i)));
dVG2yA(i)= l2 *ddT1(i)+(l3/2)*(2*dT1(i)*dT2(i)*cos(T2(i))-ddT1(i)*cos(T2(i)));
dVG2zA(i)= -l2 *dT1(i)^2 * sin(T2(i))-(l3/2)*(dT1(i)^2*sin(T2(i))^2+dT2(i)^2);

//3vG3point
dVG3xA(i) = -l2*dT1(i)^2*cos(T2(i)+T3(i))+l3*(dT1(i)^2*(sin(T2(i))^2*sin(T3(i))-cos(T2(i))*cos(T3(i))*sin(T2(i)))+dT2(i)^2*sin(T3(i))+ddT2(i)*cos(T3(i)))-(l4/2)*(dT1(i)^2*cos(T2(i)+T3(i))^2+(dT2(i)+dT3(i))^2);

dVG3yA(i) = l2*ddT1(i)+l3*(dT1(i)*dT2(i)*(cos(T2(i))+sin(T2(i)))+ddT1(i)*sin(T2(i)))+(l4/2)*(dT1(i)*(dT2(i)+dT3(i))*sin(T2(i)+T3(i))-dT1(i)*dT2(i)*sin(T2(i)-T3(i))+ddT1(i)*cos(T2(i)+T3(i))-dT1(i)*dT3(i)*cos(T2(i)-T3(i)));

dVG3zA(i) = -l2*dT1(i)^2*cos(T2(i)-T3(i))+l3*(dT1(i)^2*(-cos(T2(i))*sin(T2(i))*sin(T3(i))-sin(T2(i))^2*cos(T3(i)))-dT2(i)^2*cos(T3(i))+ddT2(i)*sin(T3(i))-T1(i)*dT1(i)*sin(T2(i)+T3(i))^2+(dT2(i)+dT3(i))^2)-(l4/2)*(dT1(i)^2*cos(T2(i)+T3(i))*sin(T2(i)+T3(i))+ddT2(i)+ddT3(i));
